let g:Powerline#Colorschemes#distinguished#colorscheme = Pl#Colorscheme#Init([
	\ Pl#Colorscheme#HiSegment(['SPLIT'],                               Pl#Hi#Create(Pl#Hi#Cterm(  0, 236)        ), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(  0, 235)        ), 'i': Pl#Hi#Create(Pl#Hi#Cterm(  0,  24)        ), } ),
	...
	\ Pl#Colorscheme#HiSegment(['errors'],                              Pl#Hi#Create(Pl#Hi#Cterm(231,  88), 'bold'), {                                                   'i': Pl#Hi#Create(Pl#Hi#Cterm(231,  31), 'bold'), } ),
	...
	\                           'nerd_tree:static_str.name',
	\                           'command_t:static_str.name',
	\                           'lustyexplorer:static_str.name',
	\                           'minibufexplorer.static_str.name'],     Pl#Hi#Create(Pl#Hi#Cterm(231,  124), 'bold'), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(242,  88), 'bold'), } ),
	\ Pl#Colorscheme#HiSegment(['gundo:static_str.buffer',
	\                           'command_t:raw.line',
	\                           'lustyexplorer:static_str.buffer'],     Pl#Hi#Create(Pl#Hi#Cterm(253,  88)        ), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(240,  52)        ), } ),
    \
	\ Pl#Colorscheme#HiSegment(['ctrl_p:mode',
	\                           'ctrl_p:progress',
	\                           'ctrl_p:pwd'],     Pl#Hi#Create(Pl#Hi#Cterm(231, 124), 'bold'        ), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(231,  124)        ), } ),
    \
	\ Pl#Colorscheme#HiSegment(['gundo:SPLIT',
	\                           'ctrl_p:SPLIT',
	\                           'nerd_tree:SPLIT',
	\                           'nerd_tree:pwd',
	\                           'nerd_tree:scrollpercent',
	\                           'command_t:SPLIT',
	\                           'lustyexplorer:SPLIT',
	\                           'minibufexplorer:SPLIT'],               Pl#Hi#Create(Pl#Hi#Cterm(244,  88)        ), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(240,  52)        ), } ),
	\
